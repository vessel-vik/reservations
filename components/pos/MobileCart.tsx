                ...
                <div className="fixed bottom-0 left-0 right-0 bg-neutral-800/95 backdrop-blur-sm border-t border-white/10 p-4 space-y-4 safe-area-bottom">
                    ...
                    <div className="pt-3 border-t border-white/10 space-y-3">
                        ...
                        <button
                            ...
                            disabled={cart.length === 0}
                            className="w-full bg-neutral-100 hover:bg-white disabled:bg-neutral-800 disabled:text-neutral-500 disabled:cursor-not-allowed text-neutral-900 text-sm font-semibold py-3 rounded-xl border border-white/10 transition-all flex items-center justify-center gap-2 touch-feedback"
                        >
