...
import { Trash2, Minus, Plus, CreditCard, Check, X } from "lucide-react";
                    ...
                    {editingOrderId ? (
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="w-full bg-emerald-500 hover:bg-emerald-600 disabled:bg-neutral-700 disabled:cursor-not-allowed text-white text-lg font-bold py-3 rounded-3xl shadow-lg shadow-emerald-900/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="w-full bg-neutral-700 hover:bg-neutral-600 text-white text-lg font-semibold py-3 rounded-3xl border border-white/10 transition-all flex items-center justify-center gap-2"
                            >
                                <X className="w-5 h-5" />
                                Cancel
                            </button>
