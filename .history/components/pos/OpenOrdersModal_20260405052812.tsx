                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                        {orders.map((order) => (
                            ...
                            >
                                ...
                                <div className="mt-4 rounded-2xl bg-white/5 p-3 border border-white/10">
                                    {parseOrderItems(order).length === 0 ? (
                                        <p className="text-xs text-neutral-400">No items available</p>
                                    ) : (
                                        <div className="space-y-3">
                                            {parseOrderItems(order).map((item) => (
                                                <div key={item.$id} className="grid grid-cols-[auto_1fr_auto] gap-3 items-center">
                                                    <div className="text-sm text-neutral-300">{item.quantity}x</div>
                                                    ...
                                                    <div className="text-sm font-semibold text-emerald-300 text-right">
