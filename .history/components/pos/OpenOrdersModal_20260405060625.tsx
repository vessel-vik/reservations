                                ...
                                >
                                    ...
                                    {isExpanded && (
                                        <>
                                            ...
                                            <div className="px-4 py-3 bg-slate-900/30 rounded-b-2xl flex flex-wrap gap-3">
                                                <Button
                                                    size="sm"
                                                    onClick={() => onEdit?.(order)}
                                                    className="flex-1 min-w-[160px] bg-emerald-600 hover:bg-emerald-700 text-white font-semibold"
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    className="flex-1 min-w-[140px] bg-rose-600 hover:bg-rose-700 text-white font-semibold"
                                                >
