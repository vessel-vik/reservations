...
import { Clock, ShoppingBag, AlertCircle, Edit2, Trash2, Printer, ChevronDown } from "lucide-react";
                                        ...
                                        <>
                                            ...
                                            <div className="px-4 py-3 bg-slate-900/30 rounded-b-2xl flex flex-wrap gap-2">
                                                <Button
                                                    ...
                                                    className="flex-1 bg-emerald-600 text-white hover:bg-emerald-500 border border-emerald-500/30"
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    className="flex-1 max-w-[148px] bg-amber-600 text-white hover:bg-amber-500 border border-amber-500/30"
                                                >
