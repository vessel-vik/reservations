...
export const createOrder = async (order: Omit<Order, "$id" | "$createdAt" | "$updatedAt">) => {
    try {
        ...
        // Appwrite collection may reject unknown fields like paymentMethods.
        // We intentionally omit paymentMethods from the initial create payload
        // when the collection schema does not expose it.
